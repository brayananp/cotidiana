...
export const pushTasksInputSchema = z.object({
	...
	operations: z.array(pushTaskOperationSchema).min(1).max(50),
});
...
export type TaskSyncSnapshot = z.infer<typeof taskSyncSnapshotSchema>;

export type PushTaskOperationInput = z.infer<typeof pushTaskOperationSchema>;

export type PushTasksInput = z.infer<typeof pushTasksInputSchema>;

export type PullTasksInput = z.infer<typeof pullTasksInputSchema>;
